...
class VeiculoLista extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var veiculoController = Provider.of<VeiculoController>(context);
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            Navigator.pushNamed(context, Rotas.VEICULO_ADD);
          },
        ...
        body: Padding(
          ...
          child: ListView.builder(
            itemCount: veiculoController.veiculos.length,
            itemBuilder: (BuildContext context, int index) {
              final veiculo = veiculoController.veiculos[index];
              return Card(
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute<void>(
                        builder: (BuildContext context) =>
                            VeiculoForm(veiculoSelecionada: veiculo),
                      ),
                    );
                  },
                ),
